      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-semibold text-[#a1acb8] uppercase">Total Emisoras</p>
              <p className="text-2xl font-bold text-[#566a7f]">{radios.length}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-semibold text-[#a1acb8] uppercase">Estado</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-semibold text-[#a1acb8] uppercase">Plan Actual</p>
              <p className="text-2xl font-bold text-[#566a7f]">Premium</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-50 flex flex-col sm:flex-row justify-between items-center gap-4">
            <h2 className="text-xl font-bold text-[#566a7f]">Mis Emisoras</h2>
            <div className="flex flex-wrap gap-3">
              {user?.role === 'super_admin' && (
                <button
                  onClick={() => navigate('/admin/settings')}
                  className="bg-[#697a8d]/10 text-[#697a8d] px-4 py-2 rounded-lg hover:bg-[#697a8d]/20 transition-all flex items-center space-x-2 text-sm font-semibold"
                >
          ...
          <div className="p-6">
            {radios.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-bold text-[#566a7f] mb-1">No hay emisoras registradas</h3>
                <p className="text-[#a1acb8] mb-6 text-sm">Crea tu primera emisora para comenzar a transmitir.</p>
                <button
                  onClick={() => navigate('/admin/profile/new')}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {radios.map((radio) => (
                  <div key={radio.id} className="group bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
                    ...
                    <div className="p-5">
                      <h3 className="font-bold text-[#566a7f] truncate mb-1">{radio.name}</h3>
                      <p className="text-xs text-[#a1acb8] flex items-center mb-3">
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-4">
                        <button
                          ...
                          className="flex items-center justify-center space-x-1 py-2 bg-gray-50 text-[#697a8d] rounded-lg hover:bg-gray-100 transition-colors text-xs font-semibold"
                        >
